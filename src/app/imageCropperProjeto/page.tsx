...
import { ImageCropperType } from '@/components/ui/ImageCropper';
...
export default function ImageCropPage() {
  ...
  const handleOpenModal = () => {
    if (!userId.trim()) {
      alert("Por favor, digite um ID de projeto válido.");
      return;
    }
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Editar Foto do Projeto</h1>
            <p className="text-gray-600">Digite o ID do projeto para alterar a foto do projeto</p>
          </div>
        </div>
          ...
          >
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-semibold">Escolher Foto de Projeto</h3>
                <button
