          ...
          <div className="hidden md:flex items-center justify-end w-1/4">
            ...
            <div className="hidden md:flex items-center justify-end w-1/4 gap-4">
              <button
                ...
                className="relative px-4 py-2 text-gray-200 group transition-all duration-200"
              >
                <span className="relative z-10">Entrar</span>
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gray-200 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-in-out origin-left"></span>
              </button>
              
              <button
                onClick={(e) => handleNavigation('/criar-conta', e)}
                className="px-4 py-2 bg-transparent border border-gray-200 text-gray-200 rounded-md hover:bg-gray-200 hover:text-gray-900 transition-colors duration-200"
              >
                Cadastrar
              </button>
            </div>
